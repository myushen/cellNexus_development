library(targets)
library(tidyverse)
store_file_cellNexus = "/vast/scratch/users/shen.m/targets_prepare_database_split_datasets_chunked_1_6_1_pseudobulk" # MODIFY HERE: targets store directory for this pipeline
...
tar_script({
  ...
  list(
    ...
    tar_target(cache_directory, "/vast/scratch/users/shen.m/cellNexus/hca_2024/0.4.1/pseudobulk", deployment = "main"), # MODIFY HERE: output cache directory for saved pseudobulk anndata files
    tar_target(
      cell_metadata,
      "/vast/projects/cellxgene_curated/metadata_cellxgene_mengyuan/cell_metadata_cell_type_consensus_v1_7_1_mengyuan.parquet", # MODIFY HERE: cell metadata parquet (output of step6/step7)
